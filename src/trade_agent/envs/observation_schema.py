"""Observation schema utilities (migrated from trade_agent.agents.envs).

Provides compute_observation_schema and save_observation_schema helpers for RL
environment feature validation.
"""
