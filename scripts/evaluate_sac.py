#!/usr/bin/env python3
"""
Script to evaluate the SAC agent using a deterministic policy on the
validation dataset.
"""
...
def evaluate_deterministic_policy(
    ...
    for _episode in range(n_episodes):
        ...
        while True:
            ...
            # Get policy entropy (this is a bit tricky with SB3,
            # we'll approximate)
            # For a more accurate entropy calculation, we access the
            # policy distribution
            try:
