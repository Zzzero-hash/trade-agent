"""Temporal cross‑validation (purged + embargo) utilities.

Clean, dependency‑light implementation used for SL model selection, with
support for a gap purge and trailing embargo to mitigate look‑ahead.
"""
...
) -> Callable[[Any], float]:  # pragma: no cover
    if metrics is None:
