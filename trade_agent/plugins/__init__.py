...
from collections.abc import Callable, Iterable, Iterable as _Iter
...
def iter_data_collectors() -> _Iter[tuple[str, Callable[..., Any]]]:
    return _iter("data")


def iter_rl_agent_factories() -> _Iter[tuple[str, Callable[..., Any]]]:
    return _iter("rl")


def iter_broker_adapters() -> _Iter[tuple[str, Callable[..., Any]]]:
    return _iter("broker")
